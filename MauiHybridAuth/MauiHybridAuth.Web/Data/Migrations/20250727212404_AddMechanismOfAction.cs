...
{
    /// <inheritdoc />
    public partial class AddMechanismOfAction : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MechanismOfAction", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InterventionCategory_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionEffect", x => new { x.EffectId, x.InterventionId });
                    table.ForeignKey(
                        name: "FK_InterventionEffect_Effect_EffectId",
                        column: x => x.EffectId,
            ...
            migrationBuilder.CreateTable(
                name: "InterventionMechanismOfAction",
                columns: table => new
                {
                    InterventionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MechanismOfActionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionMechanismOfAction", x => new { x.InterventionId, x.MechanismOfActionId });
                    table.ForeignKey(
                        name: "FK_InterventionMechanismOfAction_MechanismOfAction_MechanismOfActionId",
                        column: x => x.MechanismOfActionId,
                        principalTable: "MechanismOfAction",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionEffect_InterventionId",
                table: "InterventionEffect",
                column: "InterventionId");

            migrationBuilder.CreateIndex(
                name: "IX_InterventionMechanismOfAction_MechanismOfActionId",
                table: "InterventionMechanismOfAction",
                column: "MechanismOfActionId");
