...
// Testable version of HttpAuthenticationService that doesn't depend on MAUI-specific interfaces
public class TestableHttpAuthenticationService : IAuthenticationService
{
    ...
    public TestableHttpAuthenticationService(HttpClient httpClient, ISecureStorage secureStorage)
    {
...
// Mock interface for ISecureStorage since it's not available in test context
